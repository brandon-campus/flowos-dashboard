...
export const Route = createFileRoute("/register")({
  head: () => ({ meta: [{ title: "Registrarse — FlowOS" }] }),
  component: Register,
});
    ...
    <div className="flex min-h-screen items-center justify-center px-4 py-12 bg-[#FAFAFA] dark:bg-[#000000]">
      <div className="w-full max-w-[400px]">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-[#111827] dark:text-[#F9FAFB]">Crear una cuenta</h1>
          <p className="text-sm text-[#6B7280] dark:text-[#A1A1AA] mt-2">Empezá a organizar tus proyectos hoy</p>
        </div>
